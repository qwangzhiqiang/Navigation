...
var citySelect = {
    ...
    citySelect: document.getElementsByClassName('citySelect')[0],
    ...
    cityMouseEnter: function (e) {
        ...
        this.cityNode.style.display = 'block';
        var num = e.target.index;
        e.target.style.backgroundColor = '#f1f3f6';
        var cityDate = this.city[num];
        console.log(cityDate);
        var cityStr = '';
        for (var i = 0; i < cityDate.length; i++) {
            cityStr += '<li>' + cityDate[i][1] + '</li>';
        }
        this.ul_city.innerHTML = '';
        this.ul_city.innerHTML = cityStr;

        this.li_city = this.ul_city.getElementsByTagName('li');
        for (var i = 0; i < this.li_city.length; i++) {
            this.li_city[i].addEventListener('click',this.city_li_click.bind(this))
        }

    },
    showProvince: function () {
        var self = this;
        this.citySelect.onclick = function () {
            if (self.bool) {
                self.provinceNode.style.display = 'block';
                self.bool = false;
            } else {

                self.provinceNode.style.display = 'none';
    ...
    city_li_click:function(e){
        var str = e.target.innerHTML;
        this.fontstr.innerHTML = str;
        this.provinceNode.style.display = 'none';
        this.cityNode.style.display = 'none';
    }
